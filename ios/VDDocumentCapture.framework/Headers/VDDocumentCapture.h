 ...
 */
+ (UIViewController*) startWithDelegate: (UIViewController <VDDocumentCaptureProtocol> *) delegate andDocuments:(NSArray<VDDocument*>*)documents __attribute__((deprecated("Should be used start with NSString documents")));
...
/**
 ...
 @return (UIViewController) The UIViewController that is shown.
 */
+ (UIViewController*) startWithDelegate: (UIViewController <VDDocumentCaptureProtocol> *) delegate andDocuments:(NSArray<VDDocument*>*)documents andConfiguration:(NSDictionary*) config __attribute__((deprecated("Should be used start with NSString documents")));
...
// @param logger (NSObject <VDLogger>*) NSObject that implements a VDLogger protocol.
// @param loggerId (NSString*) Name of the logger.
// */
//+ (void) addLogger:(NSObject<VDLogger>*)logger withId:(NSString*)loggerId;
